...
**Latest Owner overlay:** 2026-09-25

## 2026-09-25 DC01 Public Hostname Migration Overlay

- DC01 hostname migration = **PASS** at DocCraft `c5190757645c9e7619967820c7f777aca17cea62` (DocCraft `master`).
- Canonical production: `https://doccraft.wstera.com` = **LIVE**.
- Legacy `https://dc01.wstera.com` = **LIVE**, compatibility mode **dual-serve** (same Worker `wstera-dc01`, same app; no cross-host redirect).
- `dc01.wstera.com` must not be redirected or sunset without a draft-migration plan: drafts are browser `localStorage`, scoped per origin.
...
| DocCraft / DC01 V1 Gate 6 | **PASS / CLOSED** at reviewed implementation `01115cc908adcbc4224d3d7878f8680da287439e`; production live at canonical `doccraft.wstera.com` (legacy `dc01.wstera.com` dual-serve; hostname migration PASS 2026-09-25 at DocCraft `c519075`); Public Pilot / PV Gate **OPENED 2026-09-08** at DocCraft `70054e7`; Phase 7 Cloud/Auth/Supabase remains frozen until PV Gate = PASS |
...
| DC01 | DocCraft | **V1 Gate 6 PASS / CLOSED** at reviewed implementation `01115cc908adcbc4224d3d7878f8680da287439e`; production live at canonical `doccraft.wstera.com` (legacy `dc01.wstera.com` dual-serve; hostname migration PASS 2026-09-25 at DocCraft `c519075`); **Public Pilot / PV Gate OPEN** from DocCraft `70054e7` with zero real-user evidence recorded at launch. Phase 7 Cloud/Auth/Supabase remains gated by PV; Phase 8 billing and Phase 9 post-MVP remain frozen |
