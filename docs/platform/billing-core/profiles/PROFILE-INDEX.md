...
|---|---|---|---|---|---|
| 1 | Pawstia PMS | PS01 | recurring subscription | Founding C2 THB 990/month, first 10 invitation-only | `pending_validation` â€” build first |
| 2 | WSTERA Link | LK01 | free + recurring subscription | baseline 199/590 used for Test mapping; final public pricing/quota unresolved | `pending_validation` — Product #2 test profile |
| 3 | WSM | WS01 | recurring subscription | packages/pricing/trial unresolved | `draft` |
| 4 | DocCraft | DC01 | free pilot -> one-time unlock | future experiment THB 299â€“599 | `draft` |
| 5 | Multi-Tenant AI Starter Kit | MT01 | one-time source sale | direction USD 149â€“199; purchased version perpetual + 12 months updates | `draft` |
