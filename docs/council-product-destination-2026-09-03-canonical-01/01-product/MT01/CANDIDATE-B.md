...
Role: Independent Council expert. This is NOT a gate verdict and I do not set pricing/license economics. I answer the gate question (`What exactly is the sellable MT01 artifact, for whom, and where does V1 end?`) from direct git/source/test inspection, per the frozen brief.
