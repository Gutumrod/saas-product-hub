# SYNTHESIS MANIFEST — DC01 Business/Market Gate
...
- Three independent expert answers were collected for the DC01 Business/Market Gate.
- All three required current external evidence (competitors, current pricing, revenue-model fit, alternatives/status quo, willingness-to-pay, distribution/sales friction) with URL/source/date.
- External evidence was fetched on 2026-09-04 by the experts (e.g. FlowAccount, PEAK, BillKub, Zoho Invoice, Wave pricing).
...
- Thai accounting/document software competitors and pricing (FlowAccount, PEAK, BillKub, Zoho Invoice, Wave).
- Indirect alternatives/status quo (Word/Excel templates, full accounting software).
- Revenue model fit (subscription / one-time / usage / hybrid).
- Willingness-to-pay evidence for the no-login Thai business-document wedge.
- DC01 product repo state (verified live by experts on 2026-09-04).
