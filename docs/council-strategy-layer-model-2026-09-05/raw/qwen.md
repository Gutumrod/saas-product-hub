node.exe : Warning: running headless with --yolo / approval-mode=yolo and no sandbox. All tool calls (shell, write, 
edit) auto-execute at this process's privilege level. Enable a sandbox via --sandbox / QWEN_SANDBOX, or set 
QWEN_CODE_SUPPRESS_YOLO_WARNING=1 to silence this notice.
At D:\AI-Workspace\runtime\npm-global\npm\qwen.ps1:24 char:5
+     & "node$exe"  "$basedir/node_modules/@qwen-code/qwen-code/cli-ent ...
+     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (Warning: runnin...ce this notice.:String) [], RemoteException
